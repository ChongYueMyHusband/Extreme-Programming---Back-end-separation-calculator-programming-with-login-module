...
public class RegisterHTTPUtil {
    ...
    private static final String TAG = "RegisterHTTPUtil";
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String username, String password) {
        String result = "";
        try {
            String path = "http://10.133.52.201:8081/register";
