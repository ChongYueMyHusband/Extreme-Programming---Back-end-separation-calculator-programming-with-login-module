...
class SendRegisterMqttUtil {
    private String registerString;
    private Context context;

    private final String TAG = "SendRegisterMqttUtil";
    final private String PUB_TOPIC = "pub_register";	//发送主题
    final private String SUB_TOPIC = "sub_register";	//订阅主题
    ...
    public SendRegisterMqttUtil(String registerString, Context context){
        ...
        try {
            mqttAndroidClient.connect(mqttConnectOptions,null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    publishMessage(registerString);

                    // 在连接成功后，调用 disconnect 方法
                    disconnect();
                }
        ...
        try {
            mqttAndroidClient.subscribe(topic, 0, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    Log.i("TestRegister", registerString);
                }
     ...
     * @param registerString 消息载荷
     */
    public void publishMessage(String registerString) {
        try {
            ...
            message.setPayload(registerString.getBytes());
