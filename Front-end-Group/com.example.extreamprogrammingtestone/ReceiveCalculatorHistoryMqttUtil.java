...
class ReceiveCalculatorHistoryMqttUtil {
    private String requestInfo;
    private Context context;

    private final String TAG = "ReceiveCalculatorHistoryMqttUtil";
    final private String PUB_TOPIC = "pub_CalculatorHistoryInfo";	//发送主题
    final private String SUB_TOPIC = "sub_CalculatorHistoryInfo";	//订阅主题
    ...
    public ReceiveCalculatorHistoryMqttUtil(String requestInfo, Context context){
