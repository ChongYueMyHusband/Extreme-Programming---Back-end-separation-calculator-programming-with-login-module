...
import com.example.Bean.MQTTConfig;
...
public class MQTTServer {
  ...
  /*  @Autowired
    ...
    public MqttPahoMessageDrivenChannelAdapter mqttInbound() {
        MqttPahoMessageDrivenChannelAdapter adapter =
                new MqttPahoMessageDrivenChannelAdapter(config.getHost(), config.getClientid(), "pub_register");
  ...
  /*  @SneakyThrows
    @ServiceActivator(inputChannel = "pub_register")
    public void handleMessage(Message<MqttMessage> message) {
