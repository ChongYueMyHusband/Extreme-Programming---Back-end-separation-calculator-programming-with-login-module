...
class SendModifyMqttUtil {
    private String modifyString;
    private Context context;

    private final String TAG = "SendModifyMqttUtil";
    final private String PUB_TOPIC = "pub_modifyInfo";	//发送主题
    final private String SUB_TOPIC = "sub_modifyInfo";	//订阅主题
    ...
    public SendModifyMqttUtil(String modifyString, Context context){
        this.modifyString = modifyString;
        this.context = context;
    }

    //执行 MQTT 连接和消息发布的核心方法
    protected void sendModifyStringInfo() {
     ...
     * @param modifyString 消息载荷
     */
    public void publishMessage(String modifyString) {
        try {
            ...
            // 消息内容是通过将 modifyString 字符串转换为字节数组来设置的。
            message.setPayload(modifyString.getBytes());
            ...
            mqttAndroidClient.publish(PUB_TOPIC, message, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    Log.i("TestAccount", modifyString);
                }
