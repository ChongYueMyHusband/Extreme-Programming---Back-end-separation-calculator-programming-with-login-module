...
class ReceiveDepositLoanHistoryMqttUtil {
    private String requestInfo;
    private Context context;

    private final String TAG = "ReceiveDepositLoanHistoryMqttUtil";
    final private String PUB_TOPIC = "pub_DepositLoanHistoryInfo";	//发送主题
    final private String SUB_TOPIC = "sub_DepositLoanHistoryInfo";	//订阅主题
    ...
    public ReceiveDepositLoanHistoryMqttUtil(String requestInfo, Context context){
        this.requestInfo = requestInfo;
        this.context = context;
    }

    //执行 MQTT 连接和消息发布的核心方法
    protected void sendRequestInfoInfo() {
     ...
     * @param requestInfo 消息载荷
     */
    public void publishMessage(String requestInfo) {
        try {
            ...
            // 消息内容是通过将 requestInfo 字符串转换为字节数组来设置的。
            message.setPayload(requestInfo.getBytes());
