...
class SendEnquireMqttUtil {
    private String enquireString;
    private Context context;

    private final String TAG = "SendEnquireMqttUtil";
    final private String PUB_TOPIC = "pub_enquireInfo";	//发送主题
    final private String SUB_TOPIC = "sub_enquireInfo";	//订阅主题
    ...
    public SendEnquireMqttUtil(String enquireString, Context context){
        this.enquireString = enquireString;
        this.context = context;
    }

    //执行 MQTT 连接和消息发布的核心方法
    protected void sendEnquireStringInfo() {
        ...
        mqttAndroidClient.setCallback(new MqttCallback() {
            ...
            public void messageArrived(String topic, MqttMessage message) throws Exception {
                ...
                // 更新 TextView 中的文本
                updateTextViewContent(receivedMessage);
            }
     ...
     * @param enquireString 消息载荷
     */
    public void publishMessage(String enquireString) {
        try {
            ...
            // 消息内容是通过将 enquireString 字符串转换为字节数组来设置的。
            message.setPayload(enquireString.getBytes());
            ...
            mqttAndroidClient.publish(PUB_TOPIC, message, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    Log.i("TestAccount", enquireString);
                }
