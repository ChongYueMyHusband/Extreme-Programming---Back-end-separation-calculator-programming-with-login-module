...
public class PersonalInfoActivity extends AppCompatActivity implements PersonalInfoAsyncTask.OnPersonalInfoResultListener {
    ...
    private String username;  // 用户名，账号，唯一的账号
    ...
    private String imageString; // 头像的string表达
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String username = sp.getString("username", PersonalinfoMessage.getUser());
        String pwd = sp.getString("password", PersonalinfoMessage.getPsw());
        String savedUserName = sp.getString("userName", "");
        String savedIdiograph = sp.getString("idiograph", "");
        String savedSex = sp.getString("sex", "");
        String savedAge = sp.getString("age", "");
        String savedPhoto = sp.getString("avatar", "");
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // 将这些数据合并成一个字符串
                String personalInfoString = "account=" + username + "&password=" + pwd + "&userName=" + userName + "&userIdiograph=" + userIdiograph + "&userSex=" + userSex + "&userAge=" + userAge;
//                // 使用 SendPersonalInfoMqttUtil 发送数据到服务器
//                SendPersonalInfoMqttUtil sendPersonalInfoMqttUtil = new SendPersonalInfoMqttUtil(personalInfoString, PersonalInfoActivity.this);
//                sendPersonalInfoMqttUtil.sendPersonalInfo();
                ...
                // 执行新的实例
                personalInfoAsyncTask.execute(username, pwd, userName, userAge, userSex, userIdiograph);
