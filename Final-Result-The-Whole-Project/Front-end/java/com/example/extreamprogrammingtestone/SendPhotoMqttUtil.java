...
public class SendPhotoMqttUtil {
    private String imageString;
    private Context context;

    private final String TAG = "SendPhotoMqttUtil";
    final private String PUB_TOPIC = "pub_photo";	//发送主题
    final private String SUB_TOPIC = "sub_photo";	//订阅主题
...
//    final String host = "ws://114.55.245.48:8083";	//服务器地址（协议+地址+端口号）
    ...
    public SendPhotoMqttUtil(String imageString, Context context){
