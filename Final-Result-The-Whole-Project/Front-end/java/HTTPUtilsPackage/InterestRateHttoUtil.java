...
public class InterestRateHttoUtil {
    private static final String TAG = "CalculatorHistoryHTTPUtil";
    ...
    public static String sendPost(String Period,String rate,String type, String command) {
        String result = "";
        try {
            if(type.equals("Deposit") && command.equals("enquire")) {
                path = "http://10.133.52.201:8081/searchDepositInterestRate";
            } else if(type.equals("Deposit") && command.equals("modify")){
                path= "http://10.133.52.201:8081/updateDepositInterestRate";
            } else if(type.equals("Loan") && command.equals("enquire")){
                path= "http://10.133.52.201:8081/searchLoanInterestRate";
            } else if(type.equals("Loan") && command.equals("modify")){
                path= "http://10.133.52.201:8081/updateLoanInterestRate";
            }
            ...
            Log.e("InterestRateHttoUtil",data);
            // 3. 设置连接信息
