...
public class PersonalInfoHTTPUtil {
    private static final String TAG = "PersonalInfoHTTPUtil";
    /**
     * 向指定 URL 发送POST方法的请求
     *
     * @param username 用户名
    ...
    public static String sendPost(String username, String password, String userName, String age, String sex, String idiograph) {
        String result = "";
        try {
            String path = "http://10.133.52.201:8081/PersonalInfo";
            ...
            jsonData.put("account", username);
            jsonData.put("password", password);
            jsonData.put("userName", userName);
            jsonData.put("age", age);
            jsonData.put("sex", sex);
            jsonData.put("idiograph", idiograph);
