...
public class CalculatorHistoryHTTPUtil {
    ...
    public static String sendPost(String ans,String username) {
        String result = "";
        try {
            String path = "http://10.133.52.201:8081/calculateResult/history";
            ...
            jsonData.put("result", ans);
            jsonData.put("account", username);
            String data = jsonData.toString();
            Log.e("CalculatorHTTPUtil",data);
            // 3. 设置连接信息
