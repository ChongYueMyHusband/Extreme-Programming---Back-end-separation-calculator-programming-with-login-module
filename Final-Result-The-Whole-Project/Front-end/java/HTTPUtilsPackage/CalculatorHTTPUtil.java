...
public class CalculatorHTTPUtil {
    private static final String TAG = "CalculatorHTTPUtil";
    /**
     * 向指定 URL 发送POST方法的请求
     *
     * @param username 用户名
    ...
    public static String sendPost(String ans,String username) {
        String result = "";
        try {
            String path = "http://10.133.52.201:8081/calculateResult/saveHistory";
